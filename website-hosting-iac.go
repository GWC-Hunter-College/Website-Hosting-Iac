...
// func NewWebsiteHostingIacStack(scope constructs.Construct, id string, props *WebsiteHostingIacStackProps) awscdk.Stack {
...
// 	// example resource
// 	// queue := awssqs.NewQueue(stack, jsii.String("WebsiteHostingIacQueue"), &awssqs.QueueProps{
...
func main() {
	...
	// NewWebsiteHostingIacStack(app, "WebsiteHostingIacStack", &WebsiteHostingIacStackProps{
	// 	awscdk.StackProps{
	// 		Env: env(),
	// 	},
	// })
